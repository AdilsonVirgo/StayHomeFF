                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header border-transparent">
                            <form   method="post" action="{{url('/provincias')}}" id="provincia-form">
                                {{ csrf_field() }}       
                            ...
                            <a id="fb1" class="btn btn-outline-success" href="/home"
                               onclick="event.preventDefault();
                                       ...
                                       ">
                                Crear Nueva Provincia</a>
                            <br/>
                            <a href="/ralojamientos" class="btn btn rounded border border-warning pull-right">
                                <i class="fa fa-mouse-pointer"> Volver a ReservaAlojamiento </i></a>
                            <a href="/uebs" class="btn btn rounded border border-warning pull-right">
                                <i class="fa fa-mouse-pointer"> Volver a Ueb </i></a>
                        </div><!--/. container-fluid -->
                    </div><!--/. container-fluid -->
                </div><!--/. container-fluid -->
            </div><!--/. container-fluid -->
